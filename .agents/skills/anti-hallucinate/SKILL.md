...
description: "Anti-hallucination guardrails for AI agents. Enforces 'I don't know' responses, citation verification, and self-checking loops. Use when building or configuring agents that must avoid fabricating facts, sources, or statistics. Also use when the user mentions 'grounding,' 'source filtering,' 'anti-hallucination,' 'fact-checking,' 'confidence calibration,' or 'prevent hallucinations.'"
---
